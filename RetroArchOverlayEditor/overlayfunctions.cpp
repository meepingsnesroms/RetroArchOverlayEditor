...
void OverlayFunctions::on_heightAdjuster_sliderReleased(){
   double scaler = (double)ui->heightAdjuster->value() / 50.0;
   ...
   ((MainWindow*)parentWidget())->editor->resize(1.0, scaler);
   ui->heightAdjuster->setValue(50);
}
